...
void TraCIAPI::send_commandGetVariable(int domID, int varID, const std::string &objID, tcpip::Storage *add) const
{
    if (mySocket == 0)
    {
...
void TraCIAPI::send_commandSetValue(int domID, int varID, const std::string &objID, tcpip::Storage &content) const
{
    if (mySocket == 0)
    {
        throw tcpip::SocketException("Socket is not initialised");
...
void TraCIAPI::send_commandSubscribeObjectVariable(int domID, const std::string &objID, SUMOTime beginTime, SUMOTime endTime,
...
void TraCIAPI::send_commandSubscribeObjectContext(int domID, const std::string &objID, SUMOTime beginTime, SUMOTime endTime,
...
void TraCIAPI::send_commandMoveToXY(const std::string &vehicleID, const std::string &edgeID, const int lane, const SUMOReal x, const SUMOReal y, const SUMOReal angle, const int keepRoute) const
{
...
void TraCIAPI::check_resultState(tcpip::Storage &inMsg, int command, bool ignoreCommandId, std::string *acknowledgement) const
{
...
int TraCIAPI::check_commandGetResult(tcpip::Storage &inMsg, int command, int expectedType, bool ignoreCommandId) const
{
...
void TraCIAPI::processGET(tcpip::Storage &inMsg, int command, int expectedType, bool ignoreCommandId) const
{
...
int TraCIAPI::getUnsignedByte(int cmd, int var, const std::string &id, tcpip::Storage *add)
{
    tcpip::Storage inMsg;
    send_commandGetVariable(cmd, var, id, add);
...
int TraCIAPI::getByte(int cmd, int var, const std::string &id, tcpip::Storage *add)
{
    tcpip::Storage inMsg;
    send_commandGetVariable(cmd, var, id, add);
...
int TraCIAPI::getInt(int cmd, int var, const std::string &id, tcpip::Storage *add)
{
    tcpip::Storage inMsg;
    send_commandGetVariable(cmd, var, id, add);
    processGET(inMsg, cmd, TYPE_INTEGER);
...
void TraCIAPI::readVariables(tcpip::Storage &inMsg, const std::string &objectID, int variableCount, SubscribedValues &into)
{
...
void TraCIAPI::readVariableSubscription(tcpip::Storage &inMsg)
{
...
void TraCIAPI::readContextSubscription(tcpip::Storage &inMsg)
{
...
void TraCIAPI::simulationStep(SUMOTime time)
{
...
void TraCIAPI::EdgeScope::adaptTraveltime(const std::string &edgeID, SUMOReal time) const
{
    tcpip::Storage content;
...
void TraCIAPI::EdgeScope::setEffort(const std::string &edgeID, SUMOReal effort) const
{
    tcpip::Storage content;
...
void TraCIAPI::EdgeScope::setMaxSpeed(const std::string &edgeID, SUMOReal speed) const
{
    tcpip::Storage content;
...
void TraCIAPI::GUIScope::setZoom(const std::string &viewID, SUMOReal zoom) const
{
    tcpip::Storage content;
...
void TraCIAPI::GUIScope::setOffset(const std::string &viewID, SUMOReal x, SUMOReal y) const
{
    tcpip::Storage content;
...
void TraCIAPI::GUIScope::setSchema(const std::string &viewID, const std::string &schemeName) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRING);
...
void TraCIAPI::GUIScope::setBoundary(const std::string &viewID, SUMOReal xmin, SUMOReal ymin, SUMOReal xmax, SUMOReal ymax) const
{
    tcpip::Storage content;
...
void TraCIAPI::GUIScope::screenshot(const std::string &viewID, const std::string &filename) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRING);
...
void TraCIAPI::GUIScope::trackVehicle(const std::string &viewID, const std::string &vehID) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRING);
...
void TraCIAPI::LaneScope::setAllowed(const std::string &laneID, const std::vector<std::string> &allowedClasses) const
{
    tcpip::Storage content;
...
void TraCIAPI::LaneScope::setDisallowed(const std::string &laneID, const std::vector<std::string> &disallowedClasses) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRINGLIST);
...
void TraCIAPI::LaneScope::setMaxSpeed(const std::string &laneID, SUMOReal speed) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
    content.writeDouble(speed);
...
void TraCIAPI::LaneScope::setLength(const std::string &laneID, SUMOReal length) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
...
void TraCIAPI::POIScope::setType(const std::string &poiID, const std::string &setType) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRING);
...
void TraCIAPI::POIScope::setPosition(const std::string &poiID, SUMOReal x, SUMOReal y) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(POSITION_2D);
    content.writeDouble(x);
...
void TraCIAPI::POIScope::setColor(const std::string &poiID, const TraCIColor &c) const
{
    tcpip::Storage content;
...
void TraCIAPI::POIScope::add(const std::string &poiID, SUMOReal x, SUMOReal y, const TraCIColor &c, const std::string &type, int layer) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_COMPOUND);
    content.writeInt(4);
...
void TraCIAPI::POIScope::remove(const std::string &poiID, int layer) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_INTEGER);
    content.writeInt(layer);
...
void TraCIAPI::PolygonScope::setType(const std::string &polygonID, const std::string &setType) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRING);
    content.writeString(setType);
...
void TraCIAPI::PolygonScope::setShape(const std::string &polygonID, const TraCIAPI::TraCIPositionVector &shape) const
{
    tcpip::Storage content;
...
void TraCIAPI::PolygonScope::setColor(const std::string &polygonID, const TraCIColor &c) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_COLOR);
    content.writeUnsignedByte(c.r);
...
void TraCIAPI::PolygonScope::add(const std::string &polygonID, const TraCIAPI::TraCIPositionVector &shape, const TraCIColor &c, bool fill, const std::string &type, int layer) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_COMPOUND);
    content.writeInt(4);
...
void TraCIAPI::PolygonScope::remove(const std::string &polygonID, int layer) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_INTEGER);
    content.writeInt(layer);
...
void TraCIAPI::RouteScope::add(const std::string &routeID, const std::vector<std::string> &edges) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRINGLIST);
...
void TraCIAPI::SimulationScope::subscribe(int domID, const std::string &objID, SUMOTime beginTime, SUMOTime endTime, const std::vector<int> &vars) const
{
...
void TraCIAPI::SimulationScope::subscribeContext(int domID, const std::string &objID, SUMOTime beginTime, SUMOTime endTime, int domain, SUMOReal range, const std::vector<int> &vars) const
{
...
void TraCIAPI::TrafficLightScope::setPhase(const std::string &tlsID, int index) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_INTEGER);
...
void TraCIAPI::TrafficLightScope::setProgram(const std::string &tlsID, const std::string &programID) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRING);
...
void TraCIAPI::TrafficLightScope::setPhaseDuration(const std::string &tlsID, int phaseDuration) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_INTEGER);
...
void TraCIAPI::TrafficLightScope::setCompleteRedYellowGreenDefinition(const std::string &tlsID, const TraCIAPI::TraCILogic &logic) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_COMPOUND);
...
void TraCIAPI::VehicleTypeScope::setLength(const std::string &typeID, SUMOReal length) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
    content.writeDouble(length);
...
void TraCIAPI::VehicleTypeScope::setMaxSpeed(const std::string &typeID, SUMOReal speed) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
    content.writeDouble(speed);
...
void TraCIAPI::VehicleTypeScope::setVehicleClass(const std::string &typeID, const std::string &clazz) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRING);
...
void TraCIAPI::VehicleTypeScope::setSpeedFactor(const std::string &typeID, SUMOReal factor) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
...
void TraCIAPI::VehicleTypeScope::setSpeedDeviation(const std::string &typeID, SUMOReal deviation) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
...
void TraCIAPI::VehicleTypeScope::setEmissionClass(const std::string &typeID, const std::string &clazz) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRING);
    content.writeString(clazz);
...
void TraCIAPI::VehicleTypeScope::setWidth(const std::string &typeID, SUMOReal width) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
...
void TraCIAPI::VehicleTypeScope::setMinGap(const std::string &typeID, SUMOReal minGap) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
...
void TraCIAPI::VehicleTypeScope::setShapeClass(const std::string &typeID, const std::string &clazz) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_STRING);
    content.writeString(clazz);
...
void TraCIAPI::VehicleTypeScope::setAccel(const std::string &typeID, SUMOReal accel) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
...
void TraCIAPI::VehicleTypeScope::setDecel(const std::string &typeID, SUMOReal decel) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
...
void TraCIAPI::VehicleTypeScope::setImperfection(const std::string &typeID, SUMOReal imperfection) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
...
void TraCIAPI::VehicleTypeScope::setTau(const std::string &typeID, SUMOReal tau) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
...
void TraCIAPI::VehicleTypeScope::setColor(const std::string &typeID, const TraCIColor &c) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_COLOR);
    content.writeUnsignedByte(c.r);
...
int TraCIAPI::VehicleScope::getSpeedMode(const std::string &vehID) const
{
...
void TraCIAPI::VehicleScope::remove(const std::string &vehicleID, char reason) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_BYTE);
...
void TraCIAPI::VehicleScope::moveTo(const std::string &vehicleID, const std::string &laneID, SUMOReal position) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_COMPOUND);
    content.writeInt(2);
...
void TraCIAPI::VehicleScope::moveToXY(const std::string &vehicleID, const std::string &edgeID, const int lane, const SUMOReal x, const SUMOReal y, const SUMOReal angle, const int keepRoute) const
{
...
void TraCIAPI::VehicleScope::slowDown(const std::string &vehicleID, SUMOReal speed, int duration) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_COMPOUND);
    content.writeInt(2);
...
void TraCIAPI::VehicleScope::setSpeed(const std::string &vehicleID, SUMOReal speed) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_DOUBLE);
    content.writeDouble(speed);
...
void TraCIAPI::VehicleScope::setColor(const std::string &vehicleID, const TraCIColor &c) const
{
    tcpip::Storage content;
    content.writeUnsignedByte(TYPE_COLOR);
    content.writeUnsignedByte(c.r);
